...
<summary style="font-size: 16px;">`presentClass` | Present climate (1980-2016)</summary>
|content|description|
|-------|-----------|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`futureClass` | Present climate (2006-2100)</summary>
|content|description|
|-------|-----------|
|1|Tropical, rainforest (Af)|
|2|Tropical, monsoon (Am)|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`presentConfidence` | Per-pixel confidence on the climate type of `presentClass`</summary>
|content|description|
|-------|-----------|
|value_range|0...100|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`futureConfidence` | Per-pixel confidence on the climate type of `futureClass`</summary>
|content|description|
|-------|-----------|
|value_range|0...100|
</details>
...
<p style='margin-top:0;margin-bottom:5;'><a href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/BECK_climateMap/BECK_climateMap.bib download=BECK_climateMap/BECK_climateMap.bibtex'><small>(Download bibtex)</small></a></p>
