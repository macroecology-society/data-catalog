...
<summary style="font-size:16px;">`precipitation`<span style="color:#C8C8C8;"> | </span>Total monthly precipitation (mm)</summary>
...
<details style='cursor:pointer;border:none;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;padding:10px;margin:0;'>
<summary style="font-size:16px;">`temperature`<span style="color:#C8C8C8;"> | </span>Mean monthly temperature (K/10)</summary>
<hr style="margin-top:0;margin-bottom:20px;">
|content|description|
|-------|-----------|
|value_range|e.g. 0...n|
...
<p style='margin-top:0;margin-bottom:5;'>
             <a target='_blank' href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/CHELSA/CHELSA.bib' download='CHELSA/CHELSA.bibtex'><small>(Download bibtex)</small></a></p>
