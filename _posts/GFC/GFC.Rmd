---
title: "Annual forest cover"
description: |
  Yearly global canopy cover percentages
preview: GFC.png
slug: GFC
categories:
  - land cover
...
<details style='cursor:pointer;border:none;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;padding:10px;margin:0;'>
<summary style="font-size:16px;">`forestDensity`<span style="color:#C8C8C8;"> | </span>Forest cover density (%) of pixels with a minimum canopy density of 30%</summary>
<hr style="margin-top:0;margin-bottom:20px;">
|content|description|
|-------|-----------|
|value_range|e.g. 0...100|
...
<p>[1] Hansen, Potapov, Moore, Hancher, Turubanova, Tyukavina, Thau, Stehman, Goetz, Loveland, Kommareddy, Egorov, Chini, Justice, and Townshend (2013)</p>
<hr>
</div>
