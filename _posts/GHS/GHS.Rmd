...
<summary style="font-size: 16px;">`built` | Presence of built structures</summary>
|content|description|
|-------|-----------|
|value_range|0...1|
</details>
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`smod` | Classification of settlement types</summary>
|content|description|
|-------|-----------|
|1|Cities|
|2|Towns and suburbs|
...
<p style='margin-top:0;margin-bottom:5;'><a href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/GHS/GHS.bib download=GHS/GHS.bibtex'><small>(Download bibtex)</small></a></p>
