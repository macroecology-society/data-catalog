...
<summary style="font-size: 16px;">`cattle` | Cattle density (nr. per km2)</summary>
|content|description|
|-------|-----------|
|value_range|0...n|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`buffalos` | Buffalo density (nr. per km2)</summary>
|content|description|
|-------|-----------|
|value_range|0...n|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`sheep` | Sheep density (nr. per km2)</summary>
|content|description|
|-------|-----------|
|value_range|0...n|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`goats` | Goats density (nr. per km2)</summary>
|content|description|
|-------|-----------|
|value_range|0...n|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`pigs` | Pigs density (nr. per km2)</summary>
|content|description|
|-------|-----------|
|value_range|0...n|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`chickens` | Chicken density (nr. per km2)</summary>
|content|description|
|-------|-----------|
|value_range|0...n|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`ducks` | Duck density (nr. per km2)</summary>
|content|description|
|-------|-----------|
|value_range|0...n|
</details>
...
<p style='margin-top:0;margin-bottom:5;'><a href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/GLW_aw/GLW_aw.bib download=GLW_aw/GLW_aw.bibtex'><small>(Download bibtex)</small></a></p>
