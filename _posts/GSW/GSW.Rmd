...
<summary style="font-size:16px;">`permanent`<span style="color:#C8C8C8;"> | </span>Per-pixel densities of permanent water cover (%)</summary>
...
<details style='cursor:pointer;border:none;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;padding:10px;margin:0;'>
<summary style="font-size:16px;">`seasonal`<span style="color:#C8C8C8;"> | </span>Per-pixel densities of seasonal water cover (%)</summary>
<hr style="margin-top:0;margin-bottom:20px;">
|content|description|
|-------|-----------|
|value_range|0...100|
...
<p style='margin-top:0;margin-bottom:5;'>
             <a target='_blank' href='https://raw.githubusercontent.com/data-catalog/main/_posts/GSW/GSW.bib' download='GSW/GSW.bibtex'><small>(bibtex)</small></a></p>
