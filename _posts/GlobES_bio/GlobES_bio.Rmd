...
title: "GlobES_bio"
description: |
  Global, multi-temporal, biodiversity metrics
preview: GlobES_bio.png
slug: GlobES_bio
categories:
  - ecology
date: 2022-01-11
...
<summary style="font-size:16px;">`inverseSimpson`<span style="color:#C8C8C8;"> | </span>Per-pixel Inverse Simpson expressing the diversity of ecosystems</summary>
...
<details style='cursor:pointer;border:none;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;padding:10px;margin:0;'>
<summary style="font-size:16px;">`ecosystemCount`<span style="color:#C8C8C8;"> | </span>Per-pixel frequency of unique ecosystems</summary>
<hr style="margin-top:0;margin-bottom:20px;">
|content|description|
|-------|-----------|
|value_range|0...n|
...
<img src="GlobES_bio_extent.png" width=120, height=90>
...
<p><a href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/GlobES_bio/GlobES_bio.yml'>Propose an edit at our GitHub repository</a></p>
</aside>
