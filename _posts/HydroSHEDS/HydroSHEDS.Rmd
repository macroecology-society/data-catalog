...
<p align="justify">
HydroBASINS offers spatial data on watershed boundaries at multiple hierarchical levels. The watershed deliniation foolows the topological concept of the Pfafstetter coding system.
</p>
...
<details style='cursor:pointer;border:none;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;padding:10px;margin:0;'>
<summary style="font-size:16px;">`level3`<span style="color:#C8C8C8;"> | </span>Sub-continental basins</summary>
<hr style="margin-top:0;margin-bottom:20px;">
|content|description|
|-------|-----------|
|HYBAS_ID|Unique basin identifier|
...
<details style='cursor:pointer;border:none;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;padding:10px;margin:0;'>
<summary style="font-size:16px;">`level4`<span style="color:#C8C8C8;"> | </span>Sub-continental basins</summary>
<hr style="margin-top:0;margin-bottom:20px;">
|content|description|
|-------|-----------|
|HYBAS_ID|Unique basin identifier|
...
<details style='cursor:pointer;border:none;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;padding:10px;margin:0;'>
<summary style="font-size:16px;">`level5`<span style="color:#C8C8C8;"> | </span>Sub-continental basins</summary>
<hr style="margin-top:0;margin-bottom:20px;">
|content|description|
|-------|-----------|
|HYBAS_ID|Unique basin identifier|
...
<p style='margin-top:0;margin-bottom:5;'>
             <a target='_blank' href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/HydroSHEDS/HydroSHEDS.bib' download='HydroSHEDS/HydroSHEDS.bibtex'><small>(Download bibtex)</small></a></p>
