...
<summary style="font-size:16px;">`frequency`<span style="color:#C8C8C8;"> | </span>Number of satellite acquisitions per pixel</summary>
...
<details style='cursor:pointer;border:none;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;padding:10px;margin:0;'>
<summary style="font-size:16px;">`qualityIndex`<span style="color:#C8C8C8;"> | </span>Per-pixel acquisition quality ('quality'/'frequency')</summary>
<hr style="margin-top:0;margin-bottom:20px;">
|content|description|
|-------|-----------|
|value_range|e.g. 0...1|
