...
<summary style="font-size: 16px;">`continents` | Continent boundaries</summary>
|content|description|
|-------|-----------|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`unsd` | Continent boundaries</summary>
|content|description|
|-------|-----------|
|ogc_fid|Unique feature identifier|
|region|Region name|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`level0` | Country boundaries</summary>
|content|description|
|-------|-----------|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`level1` | Level 1 administrative boundaries (e.g. Regions)</summary>
|content|description|
|-------|-----------|
|ogc_fid0|Unique feature identifier|
|gid_0|Country ISO3 code|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`level2` | Level 2 administrative boundaries (e.g. Districts)</summary>
|content|description|
|-------|-----------|
|ogc_fid0|Unique feature identifier|
|gid_0|Country ISO3 code|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`level3` | Level 3 administrative boundaries (e.g. Counties)</summary>
|content|description|
|-------|-----------|
|ogc_fid0|Unique feature identifier|
|gid_0|Country ISO3 code|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`level4` | Level 4 administrative boundaries (e.g. Municiplality)</summary>
|content|description|
|-------|-----------|
|ogc_fid0|Unique feature identifier|
|gid_0|Country ISO3 code|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`level5` | Level 5 administrative boundaries (e.g. Commune)</summary>
|content|description|
|-------|-----------|
|ogc_fid0|Unique feature identifier|
|gid_0|Country ISO3 code|
...
<p style='margin-top:0;margin-bottom:5;'><a href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/GADM/GADM.bib download=GADM/GADM.bibtex'><small>(Download bibtex)</small></a></p>
[1]  (2012)
</div>
