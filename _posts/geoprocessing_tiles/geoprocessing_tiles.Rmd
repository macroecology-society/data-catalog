...
<summary style="font-size: 16px;">`highResolution` | Tiling system designed to download 300-m data from GEE</summary>
|content|description|
|-------|-----------|
...
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`midResolution` | Tiling system designed to process 300-m data</summary>
|content|description|
|-------|-----------|
|left|Minimum longitude|
|bottom|Minimum latitude|
