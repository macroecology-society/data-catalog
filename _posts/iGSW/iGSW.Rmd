...
title: "iGSW"
description: |
  Annual, Gap-filled Global Surface Water (GSW) from 1992 to 2018
preview: iGSW.png
slug: iGSW
categories:
  - land use
...
<p align="justify">
This dataset fills data gaps in the GSW dataset and correct for prediction biases in the original data using machine learning. It maps annual per-pixel percentages of surface water, both permanent and seasonal.
</p>
