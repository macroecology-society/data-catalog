...
<p align="justify">
This database offers yearly maps of crop types and cropping areas obtained through the statistical and spatial-temporal downscaling of national and sub-national statistics on crop production.
</p>
...
list_data("iGSW/cropType")

# data call to subdataset with a specific resolution
list_data("iGSW/cropType/100m")
```
</div>
