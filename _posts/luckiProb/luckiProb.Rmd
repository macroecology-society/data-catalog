---
title: "Global commodity probabilities"
description: |
  Annual probability layers for different agriculture commodities
preview: luckiProb.png
slug: luckiProb
categories:
  - land use
  - land cover
...
<p align="justify">
We mapped probabilities for the spatial distribution of hundreds of crop types and other land management practices (e.g. logging, pasturelands), returing per-pixel probabilities for each category.
</p>
...
list_data("luckiProb/TBD")

# data call to subdataset with a specific resolution
list_data("luckiProb/TBD/1km")
```
</div>
...
<p><a href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/luckiProb/luckiProb.yml'>Propose an edit at our GitHub repository</a></p>
</aside>
