...
<summary style="font-size: 16px;">`TreeCover` | Percent of tree cover</summary>
|content|description|
|-------|-----------|
|value_range|0...100|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`NonTreeVegetation` | Percent of short vegetation</summary>
|content|description|
|-------|-----------|
|value_range|0...100|
</details>
<details style='cursor:pointer;border: none;box-shadow: 3px 3px 4px #f8f8f8;'>
<summary style="font-size: 16px;">`NonVegetated` | Percent of non-vegetated surfaces</summary>
|content|description|
|-------|-----------|
|value_range|0...100|
</details>
...
<p style='margin-top:0;margin-bottom:5;'><a href='https://github.com/macroecology-society/data-catalog/tree/main/_posts/VCF5KYR/VCF5KYR.bib download=VCF5KYR/VCF5KYR.bibtex'><small>(Download bibtex)</small></a></p>
